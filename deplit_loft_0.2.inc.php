 ...
 class Deplit_calc
{
	...
	private $plitka40 = array(100, 100, 100); 		//длины плиток шириной 40мм
	private $plitka60 = array(100, 100, 100);		//длины плиток шириной 60мм
	private $plitka100 = array(100, 100, 100);		//длины плиток шириной 100мм
	private $plitka_thickness = array(15, 20, 25); 	//тощины плиток, соответсвуют длинам плиток
	private $plitka_width = array(100, 100, 100); 	//ширина плиток
...
/*				//проверка на повторяемость толщины первых элементов
			...
			if ($size == 100)
				...
				$this->text_render_horiz .= "<div class=\"pl".$size."-".$plitka_this_lenght."-".$plitka_this_thickness." pl_wide".$size;
				if ($trail_lenght < 0)
...
foreach ($this->manual_montage as $value)
			...
			$this->render_manual .="<div class=\"col-md-12\"><b>всего плиток - ".$all_deplit."шт.</b></div></div></div>";
