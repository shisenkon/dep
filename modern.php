...
try {
	...
	$deplit = new Deplit_calc(array('deplit_type'=>'modern', 'surface_height'=>$form->surface_height, 'surface_lenght'=>$form->surface_lenght, 'plintus100'=>$form->plintus100, 'seed_fix_check'=>$form->seed_fix_check, 'seed_fix'=>$form->seed_fix));
...
<div id="deplit_type" style="display: none">modern</div>
<div class="btn-group" style="margin:5px 0 10px 0;">
  ...
  <a href="modern.php" type="button" class="btn btn-primary">Плитка Modern</a>
    ...
    <h4>Калькулятор плитки Deplit View Modern &alpha;</h4>
